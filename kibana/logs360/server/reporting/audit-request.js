/*
 * Logs360 app - Specific methods to fetch Wazuh Audit data from Elasticsearch
...
export class AuditRequest {
   ...
   * @param {*} pattern
   */
  async getTop3AgentsSudoNonSuccessful(
    gte,
    lte,
    filters,
   ...
   * @param {*} pattern
   */
  async getTop3AgentsFailedSyscalls(
    gte,
    lte,
    filters,
    pattern = 'logs360-alerts-1.x-*'
