  ...
  return /*@__PURE__*/(function (Parser) {
    ...
    anonymous.prototype.readInt = function readInt (radix, len) {
      ...
      for (;;) {
        ...
        if (code >= 97) { val = code - 97 + 10 } // a
          ...
          if (!acceptUnderscore) { this.raise(this.pos, "Separador numérico inválido") }
          ++this.pos
      ...
      if (!acceptUnderscore) { this.raise(this.pos - 1, "Separador numérico inválido") }
    ...
    anonymous.prototype.readNumber = function readNumber (startsWithDot) {
      ...
      if (stripped.length < this.end - this.start) {
        if (octal) { this.raise(this.start, "Número invélido") }
